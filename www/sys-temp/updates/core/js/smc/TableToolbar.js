	...
	*/
	var __drawButtons = function() {
		...
		__appendButton(btns, {
			...
			init : function(button) {
				var _allow_activity = HandleItem.allowActivity && (_oControl.contentType!='objects' || (_oControl.contentType=='objects' && _oControl.enableObjectsActivity))
...
/*
	...
	*/
	this.show = function(_HandleItem, bForce) {
		...
		var posLeft     = posItemName.left + itemName.width() + cpos.left + 2;
