<?php
/**
	* @author ƒмитрий  отеров
	* @license unkown (CC, probably)
	* @site http://forum.dklab.ru/php/advises/HeuristicWithoutTheDictionaryExtractionOfARootFromRussianWord.html
*/
