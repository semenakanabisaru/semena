...
$i18n = Array(
	...
	'js-exchange-export-getfile' => 'Скачать результат экспорта',
	'js-exchange-prepare-export-submit' => 'Хотите подготовить данные к экспорту? Если не сделать этого сейчас, то в Яндекс.Маркет будут переданы неполные данные.',
	'js-exchange-prepare-export' => 'Подготовить к экспорту',
	'js-exchange-prepare-done' => 'Подготовка успешно выполнена.',
