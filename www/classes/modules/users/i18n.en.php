...
$i18n = Array(
  ...
  'js-smc-user_list' => ' ',
	...
	'error-users-non-unique-email' => 'There is other user with this e-mail. Please, choose another one.',
	'error-users-non-unique-login'	=> 'User with this login already exists.',
	'error-delete-yourself'		=> 'You can\'t delete your own account.',
	'error-users-non-referer' => 'Not defined source of action, forbidden.'
);
