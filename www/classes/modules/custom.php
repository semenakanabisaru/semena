...
<p>
 ...
 return 'ho';
	...
	public function myAdvancedSearch($per_page) { 
        ...
        $qty_check_str = " AND EXISTS (SELECT val.* FROM cms3_hierarchy_relations as rel, cms3_objects as obj, cms3_hierarchy AS hy, cms3_object_content AS val  
            where rel.rel_id = h.id and hy.id = rel.child_id and obj.id = hy.obj_id and val.obj_id = obj.id and val.field_id = 221 and val.int_val IS NOT NULL and val.int_val > 0) ";
