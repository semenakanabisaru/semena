		...
		public function seo() {
			...
			if (isset($params)) {
				...
				$data['xml:info'] = $result;
				 ...
				 $data['error'] = 'Для использования модуля необходима регистрация на сайте <a href="http://www.megaindex.ru" target="_blank" title="">MegaIndex</a>. Зарегистрируйтесь на нём, затем впишите свой логин и пароль в <a href="/admin/seo/config/" title="" >Настройках модуля</a>.';
			}
			$this->setData($data);
			return $this->doData();
