			...
			<body>
				...
				<div id="foot">
					...
					<div id="footer">
						...
						&nbsp;&nbsp; <span style="color:#787B81;font-size:10px;">Установите <a style="text-decoration:underline;color:#0088E8;" target="_blank" href="http://help.umi-cms.ru/index.html?metabar.htm">новый тулбар UMI.CMS</a> в ваш браузер, чтобы всегда быть в курсе.</span>
					</div>
				</div>
			</body>
		</html>
