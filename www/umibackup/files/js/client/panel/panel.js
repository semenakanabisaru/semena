...
uPanel.getSource = function () {
	...
	<div id="save_edit">\
		<div id="save" title="' + getLabel('js-panel-edit') + '">&#160;</div>\
	...
	if(has_meta) {
		str += '<div id="u-quickpanel-meta">\
				<table>\
					...
					<tr><td>'+getLabel('js-panel-meta-keywords')+': </td><td><input type="text" name="meta_keywords" id="u-quickpanel-metakeywords" value="'+EIP_META.meta_keywords+'"/><div class="meta_count" id="u-quickpanel-metakeywords-count"/>\
