...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="std-form-is-active">
		...
		<div class="field" style="height:auto; min-height:20px;">
			<label for="is-active" class="is-active">
				<xsl:if test="/result/data/page/@id">
						...
						jQuery(document).ready(function(){
							jQuery.getScript('//yandex.st/share/share.js', function() {
								new Ya.share({
									...
									'link': 'http://]]><xsl:value-of select="$domain" /><xsl:value-of select="document(concat('upage://', $pid))//@link" /><![CDATA[',
					...
					<div class="share" style="float:right;height:27px;font-size:20px">
