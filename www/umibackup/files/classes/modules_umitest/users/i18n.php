...
$i18n = Array(
	...
	'error-users-non-unique-email' => 'Пользователь с таким e-mail\'ом уже существует.',
	'error-users-non-unique-login'	=> 'Пользователь с таким логином уже существует.',
	'error-delete-yourself'		=> 'Нельзя удалять собственную учетную запись.',
	'error-users-non-referer' => 'Не был определен источник действия, запрещено.'
);
