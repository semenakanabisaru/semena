...
class faq extends def_module {
	...
	public function category($template = "default", $element_path = false, $limit = false, $ignore_paging = false) {		
		if($this->breakMe()) return;
	...
	public function post_question() {
		...
		) = def_module::loadTemplates("faq/default",
			"confirm_mail_subj_user", "confirm_mail_user", "confirm_mail_subj_admin", "confirm_mail_admin"
		);
		...
		$mail_adm_subj = def_module::parseContent($confirm_mail_subj_admin, $mail_arr);
		$mail_adm_content = def_module::parseContent($confirm_mail_admin, $mail_arr);
		...
		$mail_usr_subj = def_module::parseContent($confirm_mail_subj_user, $user_mail);
		$mail_usr_content = def_module::parseContent($confirm_mail_user, $user_mail);
