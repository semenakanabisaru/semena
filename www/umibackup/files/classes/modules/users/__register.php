<?php
	abstract class __register_users {
		...
		public function registrate_do($template = "default") {
			...
			) = def_module::loadTemplates("users/register/".$template,
		...
		public function onRegisterAdminMail(iUmiEventPoint $oEventPoint) {
			...
			if($oEventPoint->getMode() == "after") {
				list($template_mail, $template_mail_subject) = def_module::loadTemplates("users/register/".$template, "mail_admin_registrated", "mail_admin_registrated_subject");
				...
				$mail_subject = def_module::parseContent($template_mail_subject, $mail_arr, false, $object_id);
				$mail_content = def_module::parseContent($template_mail, $mail_arr, false, $object_id);
