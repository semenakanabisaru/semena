<?php
	abstract class __emarket_delivery {
		...
		public function removeDeliveryAddress($addressId = false) {
			...
			$customer = customer::get();
			$customer->delivery_addresses = array_filter($customer->delivery_address, create_function("\$v","return (\$v != {$addressId});"));
		...
		public function renderDeliveryList(order $order, $template) {
