...
$i18n = Array(
	...
	"cache-static-long"			=> "Длинный кеш, не более месяца",
	...
	"header-config-cache" => "Кеширование",
	"tabs-config-cache" => "Кеширование",
	...
	"group-streamscache" => "Кеширование протоколов для XSLT-шаблонизатора",
	"option-cache-enabled" => "Включено",
	"option-cache-lifetime" => "Время жизни кеша (в секундах)",
