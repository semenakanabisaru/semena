<?php
	class xmlTranslator implements iXmlTranslator {
		...
		public static function executeMacroses($userData) {
			$cmsController = cmsController::getInstance();

			if($cmsController->getCurrentMode() != "admin" && !XML_MACROSES_DISABLE) {
				$previousValue = $cmsController->isContentMode;
				$cmsController->isContentMode = true;

				$userData = templater::getInstance()->parseInput($userData);
